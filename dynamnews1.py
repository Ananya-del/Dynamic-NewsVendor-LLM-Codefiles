...
##This is the imports used: we need math for operations, random and 
## mrg32k3a to perform Gumbel, numpy for arrays, simopt to structure classes, 
## and pydantic to help with 'configuration classes'
...
class DynamNewsConfig(BaseModel):
    ...
    ## initializing all variable inputs to the problem. Annotated is used for code
    ## readability. Many arrays are used since this involves many products.
...
## all those functions make sure that you entered in valid inputs, so no
## negative costs and correct array lengths.
...
## This part calculates the total profit, trying out different order quantities.
...
## this class pretty much subs in the equations used that I discuss in the ppt
##  it includes utility 0 to utility n
...
class DynamNews(Model):
    ...
    def replicate(self) -> tuple[dict, dict]:
        ...
        return responses, {}
## this part runs the simulation as the problem description, noting that customers buy
## what is there with the highest utility. It also calculates the profit. It inits inventroy
## loops through customers, updating the product stock and inventory. It composes responses
## and gradients
